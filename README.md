...
│   ├── management/
│   │   └── commands/
│   │       └── reconcile_appointments.py   # Comando para reconciliación
│   ├── migrations/
│   ├── __init__.py
│   ├── admin.py
│   ├── apps.py
│   ├── models.py                           # Modelo Appointment
│   ├── tasks.py                            # Funciones para obtener y comparar citas
│   ├── tests.py
│   └── views.py
│
├── config/
│   ├── __init__.py
│   ├── settings.py                         # Carga .env y configura GHL/Django
│   ├── urls.py
│   └── wsgi.py
│
├── db.sqlite3                              # Base de datos local (SQLite)
├── manage.py                               # Script principal Django
├── .env                                    # Variables de entorno GHL y Django
